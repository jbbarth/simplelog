...
class Admin::AuthorsController < Admin::BaseController
  ...
  def show
    ...
    render :template => 'admin/authors/show'
  end
  ...
  def new
    ...
    @onload = "document.forms['form'].elements['author[name]'].focus()"
    render :template => 'admin/authors/new'
  end
  ...
  def create
    ...
    # whoops!
      ...
      render :action => 'new', :template => 'admin/authors/new'
    end
  end
  ...
  def edit
    ...
    @onload = "document.forms['form'].elements['author[name]'].focus()"
    render :template => 'admin/authors/edit'
  end
  ...
  def update
    ...
    # trying to set this author to inactive, but it would lock them out of the admin section--don't do it
      ...
      # whoops!
        ...
        # remember the update checking if it's there
        @update_checker = session[:update_check_stored] if session[:update_check_stored] != nil
        render :action => 'edit', :template => 'admin/authors/edit'
      end
    end
  end
